...
MemoryMonitor.RegisterMonitor("Headdy.Health",0xFFD200,UpdateHealth,true)
MemoryMonitor.RegisterMonitor("Headdy.Lives",0xFFE8EC,UpdateLives,true)
MemoryMonitor.RegisterMonitor("Headdy.Continues",0xFFE93C,UpdateContinues,true)
